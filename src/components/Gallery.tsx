...
export default function Gallery() {
  ...
  const galleryItems = [
    { id: 1, gradient: 'from-rose-200 to-rose-300', label: 'Photo 1' },
    { id: 2, gradient: 'from-amber-200 to-rose-200', label: 'Photo 2' },
    { id: 3, gradient: 'from-rose-300 to-amber-200', label: 'Photo 3' },
    { id: 4, gradient: 'from-amber-200 to-amber-300', label: 'Photo 4' },
    { id: 5, gradient: 'from-rose-200 to-amber-300', label: 'Photo 5' },
    { id: 6, gradient: 'from-amber-300 to-rose-200', label: 'Photo 6' },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          <p className="text-rose-400 text-sm tracking-[0.3em] uppercase mb-4">Memories</p>
          <h2 className="font-serif text-4xl md:text-5xl text-gray-800 mb-4">
            Our Gallery
          </h2>
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Captured moments of our love story that we treasure forever
          </p>
        </div>
        ...
        >
          <p className="text-gray-400 text-sm italic">
            ✨ Add your beautiful photos to make this gallery shine ✨
          </p>
        </div>
      </div>
          ...
          <div className="max-w-4xl w-full aspect-video rounded-2xl overflow-hidden">
            <div
              className={`w-full h-full bg-gradient-to-br ${
                galleryItems.find((item) => item.id === selectedImage)?.gradient
