  ...
  const timeline: TimelineEvent[] = [
    {
      year: '2020',
      title: 'First Meeting',
      description: 'Our paths crossed for the first time, and little did we know that this moment would change our lives forever.',
    },
    {
      year: '2021',
      title: 'First Date',
      description: 'Nervous hearts and butterflies. Our first date was magical, filled with endless conversations and shared laughter.',
    },
    {
      year: '2022',
      title: 'Falling in Love',
      description: 'Every day together made us fall deeper in love. We knew we had found something truly special.',
    },
    {
      year: '2024',
      title: 'The Proposal',
      description: 'Under a sky full of stars, Mostafa asked Sara the most important question. She said YES!',
    },
    {
      year: '2025',
      title: 'Forever Begins',
      description: 'Our wedding day marks the beginning of our forever. Thank you for being part of our journey.',
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 relative z-10">
        ...
        >
          <p className="text-rose-400 text-sm tracking-[0.3em] uppercase mb-4">Our Journey</p>
          <h2 className="font-serif text-4xl md:text-5xl text-gray-800 mb-4">
            Our Love Story
          </h2>
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            A tale of two hearts that found each other and decided to beat as one
          </p>
        </div>
