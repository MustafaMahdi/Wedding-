    ...
    <footer className="py-12 bg-gradient-to-b from-white to-rose-50 relative">
      ...
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <h3 className="font-serif text-3xl md:text-4xl text-gray-800 mb-4">
          Mostafa <span className="text-rose-400">&amp;</span> Sara
        </h3>

        {/* Date */}
        <p className="text-gray-600 mb-6">February 14, 2025</p>
        ...
        {/* Hashtag */}
        <p className="text-rose-500 font-medium mb-4">#MostafaAndSara2025</p>
